...
$(document).ready(function(){
    ...
    new Switchery(document.querySelector('.sm_disable'), { size: 'small'}).disable();


    new Switchery(document.querySelector('.sm_disable_checked'), { size: 'small',  color:'#0fb0c0',  jackColor: '#fff' }).disable();
    ...
    new Switchery(document.querySelector('.md_disable')).disable();
    new Switchery(document.querySelector('.md_disable_checked'), { color: '#668cff', jackColor: '#fff' }).disable();
