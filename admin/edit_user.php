<?php
    ...
    $id1 = $value['login_id'];
        $a = "SELECT * FROM tbl_login WHERE login_id='$id1'";
        $aa = mysqli_query($con,$a);
        $value = mysqli_fetch_array($aa);
        $id2 = $value['login_id'];
        $b = "SELECT * FROM tbl_detail WHERE login_id='$id2'";
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row m-t-25">
                                                        ...
                                                        <span class="input-group-text border-right-0 rounded-left"> <i class="fa fa-user text-primary"></i>
                                                                ...
                                                                <input type="text"  name="name" id="u-name" class="form-control" value="<?php echo $n; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                       ...
                                       <div class="form-group row">
                                                        ...
                                                        <div class="col-12 col-xl-6 col-lg-8">
                                                            <div class="input-group input-group-prepend">
                                                                ...
                                                                <input type="text" id="phone" name="phone" class="form-control"  value="<?php echo $oldphone; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                        <div class="form-group row">
                                                        ...
                                                        <div class="col-12 col-xl-6 col-lg-8">
                                                            <div class="input-group input-group-prepend">
                                                                ...
                                                                <input type="text"  value="<?php echo $add; ?>" id="address" name="address" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
